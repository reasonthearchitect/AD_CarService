package com.rta.carstore.functional.web.rest


import com.jayway.restassured.RestAssured
import com.rta.carstore.functional.AbstractFunctionTest
...
class CarFunctionalTest extends AbstractFunctionTest {
    ...
    @Test
    public void retreive_cars_list() {
    ...
    @Test
    public void no_headers_passed_only_generated_request_header_returned_for_cars_list() {
        expect().
            headers(
    ...
    @Test
    public void ensure_roles_are_carried_forward_for_cars_list() {
        expect().
            headers(
    ...
    @Test
    public void ensure_no_roles_are_generated_for_cars_list() {
        expect().
            headers(
    ...
    public void check_the_caos_filter_causes_caos_on_this_uri_with_default_404() {
        ...
        when().
            with().
                header(CaosFilter.X_CAOS_URI, "/api/v1/cars").
        get('/api/v1/cars')
    }
